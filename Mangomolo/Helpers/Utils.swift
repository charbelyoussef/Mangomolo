...
struct Constants {
    static let mediaVerticalElements = [
        Media(id: 0, image: "vertical_image1",
              ...
              adType: .preRoll),
        Media(id: 1, image: "vertical_image1", name: "Post-Roll", url: "https://storage.googleapis.com/interactive-media-ads/media/stock.mp4", adTagUrl: "https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=", adType: .postRoll),
        Media(id: 2, image: "vertical_image1", name: "Media 2", url: "https://storage.googleapis.com/interactive-media-ads/media/stock.mp4", adTagUrl: "https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=", adType: .preRoll),
    ...
    static let mediahorizontalElements = [
        Media(id: 0, image: "horizontal_image1",
              ...
              adTagUrl: "https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=",
              adType: .preRoll),
        Media(id: 1, image: "horizontal_image1", name: "Media 1", url: "https://storage.googleapis.com/interactive-media-ads/media/stock.mp4", adTagUrl: "https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=", adType: .postRoll),
        Media(id: 2, image: "horizontal_image1", name: "Media 2", url: "https://storage.googleapis.com/interactive-media-ads/media/stock.mp4", adTagUrl: "https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=", adType: .preRoll),
